...
extension Bundle {
    ...
    static var authentication: Bundle {
        ...
        // Frameworks/Authentication.framework, and its lproj resources live inside there.
        // We need to construct the path manually because Bundle(for:) can't find it.
        if let url = Bundle.main.resourceURL?
            .appendingPathComponent("Frameworks")
            .appendingPathComponent("Authentication.framework"),
